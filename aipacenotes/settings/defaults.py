default_settings = {
    ...
    'transcription_txt': '$settings_dir/transcription.txt',
    'voices_path_mod': '$unpacked_mod_dir/settings/aipacenotes/voices.json',
    'voices_path_user': '$settings_dir/voices.json',
}